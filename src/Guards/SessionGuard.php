...
class SessionGuard implements StatefulGuardInterface, SupportsBasicAuthInterface
{
     ...
     *
     * @var \HyperfExtension\Cookie\CookieJar
     */
    protected $cookieJar;
     ...
     * @param mixed $id
     *
     * @return false|\HyperfExtension\Auth\Contracts\AuthenticatableInterface
     */
     ...
     *
     * @return \HyperfExtension\Cookie\CookieJar
     */
     ...
     *
     * @param \HyperfExtension\Auth\Recaller $recaller
     */
